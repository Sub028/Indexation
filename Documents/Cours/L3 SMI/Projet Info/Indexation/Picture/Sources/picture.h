 ...
 * 
 * La structure permet de stocker les matrices RGB, la taille, le nombre de composantes et le nom.
 */
 ...
 * 
 * La structure permet de stocker la matrice BW, la taille, le nombre de composantes et le nom.
 */
