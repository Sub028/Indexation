...
#include <stdio.h>
#include <stdlib.h>
#include "dynamicIntegerTab.h"

/**
 * \fn void initTab(DynamicIntegerTab *tab, int nbValues)
...
/**
 * \fn void addValue(DynamicIntegerTab *tab, int key)
...
/**
 * \fn void changeValueAt(DynamicIntegerTab *tab, int key, int value)
...
/**
 * \fn int isVoid(DynamicIntegerTab *tab)
...
/**
 * \fn IntegerTabCell* getIntegerTabCell(DynamicIntegerTab *tab, int key)
...
/**
 * \fn void writeTab(DynamicIntegerTab *tab, FILE *file)
...
/**
 * \fn void freeIntegerTab(DynamicIntegerTab *tab)
